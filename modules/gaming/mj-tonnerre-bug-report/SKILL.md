...
- `mj-tonnerre-analyste/SKILL.md` — Technical analysis after report
- `mj-tonnerre-session/SKILL.md` — Session wrap-up (ideal time to process bugs)