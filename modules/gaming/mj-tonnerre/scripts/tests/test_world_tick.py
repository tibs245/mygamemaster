...
def _acteur_bande() -> dict:
    ...
    return {
        ...
        "trajectoire": [{"lieu": _GUE, "de": 0, "a": None}],
        "plan": [
            {
...
def _acteur_berthe() -> dict:
    return {
        ...
        "trajectoire": [{"lieu": _CABANE, "de": 0, "a": None}],
        "plan": [
...
def _acteurs_fixture() -> dict:
    return {
        ...
        "acteurs": [_acteur_bande(), _acteur_berthe()],
    }
...
class TestClasserLOD(unittest.TestCase):
    ...
    def test_froid_si_majeur_false(self):
        ...
        react = {"id": "x", "majeur": False, "plan": [], "trajectoire": []}
...
class TestPreconditionsEtBanquier(unittest.TestCase):
...
class TestPost(unittest.TestCase):
    ...
    def test_reconciliation_action_impactante_perturbe_plan(self):
        ...
        rec = next((r for r in res["reconciliations"]
                    if r["acteur"] == "faction:bande-du-corbeau"), None)
