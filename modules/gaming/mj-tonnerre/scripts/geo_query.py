...
def _charger_trajectoire_arg(campagne: Path, spec: str) -> list[dict] | None:
    ...
    if spec == "-":
        ...
        if data is None:
            ...
            return None
    # Accepts either a list of segments or {'trajectoire':[…]}.
    if isinstance(data, dict) and isinstance(data.get("trajectoire"), list):
        return data["trajectoire"]
