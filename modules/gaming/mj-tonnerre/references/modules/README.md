...
To be added at the root of each `world.json` (at the same level as `meta`, `system`, `rules`, `global_state`, `universe`):
...
|---|---|---|---|
| `voyage` | `voyage.md` | Pace, fatigue, encounters, orientation | `rules.temps.movements`, `voyage.params` |
...
| `meteo` | `meteo.md` | Weather and biodiversity | `rules.meteo`, `universe.regions[].biodiversite` |
| `worldbuilding_lieux` | `worldbuilding-locations.md` | Framework 10 points of place creation | `universe.regions[].locations` |
| `construction_royaume` | `construction-royaume.md` | Domain/kingdom construction | `system.construction_royaume`, `rules.construction`, `global_state.royaume` |
