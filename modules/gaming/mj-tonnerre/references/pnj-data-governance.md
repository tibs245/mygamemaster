...
1. **faits_etablis** contains ONLY what was played or stated verbatim. Format: `"action/revelation (played S{N})"`. Each fact must be traceable to a session.
...
✅ `"faits_etablis": ["Said that [observable detail] (played S2)"]`
...
- Is the fact in `faits_etablis`? -> ✅ usable
