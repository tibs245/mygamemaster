...
where they are baked into `/opt/modules/gaming/mygamemaster-images/scripts/`.

> Difference from `mygamemaster/scripts/` tooling (dice, validation): these two
...
```
SCRIPTS=/opt/modules/gaming/mygamemaster-images/scripts
