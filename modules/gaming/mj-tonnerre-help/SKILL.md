...
| Skill | Role |
|-------|------|
| `mj-tonnerre` | The GM themselves — persona and rules |
| `mj-tonnerre-session` | Manages sessions (wrap-up, resumption) |
| `mj-tonnerre-analyste` | Technical data audit |
| `mj-tonnerre-bug-report` | Bug reporting by the player |
| `mj-tonnerre-game-report` | Factual session report |
| `mj-tonnerre-write-history` | Narrative session account |
| `mj-tonnerre-images` | Image generation |
| `mj-tonnerre-personnage` | Character sheets |
| `mj-tonnerre-inventaire` | Inventory management |
| `mj-tonnerre-outils` | Dice rolls and actions |
| `mj-tonnerre-initiation` | Campaign creation |
| `mj-tonnerre-intendant` | Steward (consistency verification) |

---

## References

- `mj-tonnerre/SKILL.md` — GM persona and rules
