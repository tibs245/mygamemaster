...
├── modules/gaming/mygamemaster/  ← Shared modules (runtime: /opt/modules/gaming/mygamemaster/)
│
...
hermes config set terminal.cwd /opt/data/.hermes/mygamemaster/campaigns/<campaign-name> --profile <campaign-name>
