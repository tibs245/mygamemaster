...
💡 Suggestion: Add this route in world.json > regles.temps.deplacements,
...
🎒 Rubis is trying to use a "healing potion" but his inventory doesn't contain one.
   → Source: characters/100000000000000001.json → inventaire[] — "potion" not found.
...
☀️ The narration mentions rain, but regles.meteo indicates "clear sky, summer".
   → Source: world.json > regles.meteo.conditions_actuelles — "clear sky" (D7).
