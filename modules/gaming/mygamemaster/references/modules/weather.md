...
>
> **Regional data (climate, conditions, fauna, flora) are GAMEPLAY** : they live in `world.json > regles.meteo` and `world.json > universe.regions[].biodiversite`. This module describes only the generic framework and consistency rules — never the values of a specific campaign.
...
## Weather — Data Structure (in `world.json > regles.meteo`)
